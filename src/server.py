...
def add_email_account(
    email: str, password: str, quota: int = 0
) -> dict[str, str]:
...
@mcp.tool()
def delete_email_account(email: str) -> dict[str, str]:
    ...
    return api.make_call("Email", "delete_pop", params)


@mcp.tool()
def list_email_accounts(domain: str) -> dict[str, str]:
...
@mcp.tool()
def get_email_settings(email: str) -> dict[str, str]:
    ...
    return api.make_call("Email", "get_client_settings", params)


@mcp.tool()
def update_quota(email: str, quota: int) -> dict[str, str]:
...
@mcp.tool()
def change_password(email: str, new_password: str) -> dict[str, str]:
...
@mcp.tool()
def create_email_forwarder(email: str, destination: str) -> dict[str, str]:
...
@mcp.tool()
def delete_email_forwarder(email: str, destination: str) -> dict[str, str]:
...
@mcp.tool()
def list_email_forwarders(domain: str) -> dict[str, str]:
